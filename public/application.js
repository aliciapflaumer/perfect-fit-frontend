...
var workoutsEvents = __webpack_require__(17);
var planEvents = __webpack_require__(37);
...
var signOutSuccess = function signOutSuccess(id) {
...
var onCreateWorkout = function onCreateWorkout(event) {
  ...
  api.createWorkout(data).then(ui.createWorkoutSuccess).catch(ui.createWorkoutFailure);
};

var onGetAllWorkouts = function onGetAllWorkouts(event) {
  event.preventDefault();
...
var onDeleteWorkout = function onDeleteWorkout(event) {
  ...
  api.deleteWorkout(id.workout.id).then(ui.onDeleteWorkoutSuccess).catch(ui.onDeleteWorkoutFailure);
};
...
var onUpdateWorkout = function onUpdateWorkout(event) {
  ...
  api.updateWorkout(data).then(ui.onUpdateWorkoutSuccess).catch(ui.onUpdateWorkoutFailure);
};
...
var createWorkout = function createWorkout(data, id) {
  // console.log(data)
...
var showWorkoutTemplate = __webpack_require__(20);
...
var createWorkoutSuccess = function createWorkoutSuccess(response, id) {
...
var createWorkoutFailure = function createWorkoutFailure(response) {
...
var getWorkoutsSuccess = function getWorkoutsSuccess(data) {
  ...
  if (data.workouts == '') {
    ...
    var showWorkoutList = showWorkoutTemplate({ workouts: data.workouts });
    // $('#get-all-workouts-container').show()
...
var getWorkoutsFailure = function getWorkoutsFailure(response) {
  $('#workout-message').text('Getting your exercises failed. Did you create a workout yet?').show().fadeOut(8000);
};

var onDeleteWorkoutSuccess = function onDeleteWorkoutSuccess(id) {
...
var onDeleteWorkoutFailure = function onDeleteWorkoutFailure(response) {
...
var onUpdateWorkoutSuccess = function onUpdateWorkoutSuccess(id) {
...
var onUpdateWorkoutFailure = function onUpdateWorkoutFailure(id) {
...
module.exports = {
  ...
  createWorkoutFailure: createWorkoutFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<ul id=\"workout-listing\" data-id=\""
    ...
    + "</li>\n  <li>Repetition: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.repetitions : stack1), depth0))
    + "</li>\n  <!-- workout[plan_id] -->\n  <li>Plan Id: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.plan_id : stack1), depth0))
    + "</li>\n</ul>\n";
...
var onCreatePlan = function onCreatePlan(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  // console.log(data)
  // console.log('onCreatePlan events function reached!')
  api.createPlan(data).then(ui.createPlanSuccess).catch(ui.createPlanFailure);
};

var onGetAllPlans = function onGetAllPlans(event) {
  event.preventDefault();
  // const data = getFormFields(event.target)
  // console.log('onGetAllPlans events function reached!')
  api.getPlans().then(ui.getPlansSuccess).catch(ui.getPlansFailure);
};

var onDeletePlan = function onDeletePlan(event) {
  event.preventDefault();
  // console.log('onDeletePlan events function reached!')
  var id = getFormFields(event.target);
  api.deletePlan(id.plan.id).then(ui.onDeletePlanSuccess).catch(ui.onDeletePlanFailure);
};

var onUpdatePlan = function onUpdatePlan(event) {
  event.preventDefault();
  // console.log('onUpdatePlan events function re reached!')
  var data = getFormFields(event.target);

  api.updatePlan(data).then(ui.onUpdatePlanSuccess).catch(ui.onUpdatePlanFailure);
};
...
var updatePlan = function updatePlan(data) {
...
var showPlanTemplate = __webpack_require__(40);
...
var createPlanSuccess = function createPlanSuccess(response, id) {
...
var createPlanFailure = function createPlanFailure(response) {
  $('#plan-message').text('Creating a plan failed. Did you fill in all fields completely?').show().fadeOut(8000);
};

var getPlansSuccess = function getPlansSuccess(data) {
  ...
  if (data.plans == '') {
    ...
    var showPlanList = showPlanTemplate({ plans: data.plans });
    // $('#get-all-plans-container').show()
    $('#plan-listing').empty();
    $('#plan-listing').show();
...
var getPlansFailure = function getPlansFailure(response) {
  $('#plan-message').text('Getting your plans failed. Did you create a plan yet?').show().fadeOut(8000);
};

var onDeletePlanSuccess = function onDeletePlanSuccess(id) {
...
var onDeletePlanFailure = function onDeletePlanFailure(response) {
...
var onUpdatePlanSuccess = function onUpdatePlanSuccess(id) {
...
var onUpdatePlanFailure = function onUpdatePlanFailure(id) {
...
module.exports = {
  ...
  createPlanFailure: createPlanFailure,
  getPlansSuccess: getPlansSuccess,
  getPlansFailure: getPlansFailure,
  onDeletePlanSuccess: onDeletePlanSuccess,
  onDeletePlanFailure: onDeletePlanFailure,
  onUpdatePlanSuccess: onUpdatePlanSuccess,
  onUpdatePlanFailure: onUpdatePlanFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<ul id=\"plan-listing\" data-id=\""
    ...
    + "</li>\n  <li>\n    <button type=\"button\" class=\"btn btn-primary btn-sm\" data-toggle=\"modal\" data-target=\"#createExerciseModal\">Create an exercise</button>\n    <!-- <button type=\"button\" data-target=\"#workout-message\">Create an exercise</button> -->\n  </li>\n</ul>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.plans : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
